...
from Process_r09723032_江奕萱 import Process
from Detect_r09723032_江奕萱 import Detect
from util_pattern_r09723032_江奕萱 import pattern
...
if __name__ == "__main__":
    ...
    timeScale = '1min'
    signal_ls = ['threeWhiteSoldiers','fallingThreeMethods','EveningStar', 'MorningStar', 'ShootingStar',\
